<div class="space-y-6">
    ...
    <div>
        ...
        <x-text-input id="montant_en_lettre" name="MontantEnLettre" type="text" class="mt-1 block w-full" :value="old('MontantEnLettre', $pension?->MontantEnLettre)" autocomplete="MontantEnLettre" placeholder="Montantenlettre"/>
        <x-input-error class="mt-2" :messages="$errors->get('MontantEnLettre')"/>
    </div>
